...
set source0 [attach-expoo-traffic $n1 $sink0 200 2s 1s 15000k]
set source1 [attach-expoo-traffic $n2 $sink1 200 2s 1s 15000k]
set source2 [attach-expoo-traffic $n3 $sink2 200 2s 1s 15000k]
